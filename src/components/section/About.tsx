...
const About = () => {
  ...
  return (
    <section className="text-center min-h-screen w-full 2xl:-mt-[35rem] -mt-[24rem] bg-gradient-to-b from-transparent via-cyan-400 to-transparent md:via-transparent">
      <div
